...
-- DROP TABLE sgal97_s1;

CREATE TABLE sgal97_s1
(
  ...
  idenr integer NOT NULL DEFAULT nextval(('public.sgal97_s1_seq'::text)::regclass),
  ...
  CONSTRAINT pk_sgal97__s1 PRIMARY KEY (idenr ),
  CONSTRAINT p_unique_sgal97__s1 UNIQUE (n_ima , n_lot , commande , n_enr )
)
WITH (
  OIDS=TRUE
);
ALTER TABLE sgal97_s1
  OWNER TO pgtantely;
GRANT ALL ON TABLE sgal97_s1 TO pgtantely;
GRANT ALL ON TABLE sgal97_s1 TO op;
GRANT SELECT ON TABLE sgal97_s1 TO prep;

-- Index: idx1_sgal97__s1

-- DROP INDEX idx1_sgal97__s1;

CREATE INDEX idx1_sgal97__s1
  ON sgal97_s1
  USING btree
  (commande COLLATE pg_catalog."default" , n_lot COLLATE pg_catalog."default" , __s COLLATE pg_catalog."default" );

-- Index: idx2_sgal97__s1

-- DROP INDEX idx2_sgal97__s1;

CREATE INDEX idx2_sgal97__s1
  ON sgal97_s1
  USING btree
  (idexecute );

-- Index: idx3_sgal97__s1

-- DROP INDEX idx3_sgal97__s1;

CREATE INDEX idx3_sgal97__s1
  ON sgal97_s1
  USING btree
  (idenr );

-- Index: idx4_sgal97__s1

-- DROP INDEX idx4_sgal97__s1;

CREATE INDEX idx4_sgal97__s1
  ON sgal97_s1
  USING btree
  (n_lot COLLATE pg_catalog."default" );

-- Sequence: sgal97_s1_seq

-- DROP SEQUENCE sgal97_s1_seq;

CREATE SEQUENCE sgal97_s1_seq
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE sgal97_s1_seq
  OWNER TO pgtantely;
GRANT ALL ON TABLE sgal97_s1_seq TO pgtantely;
GRANT SELECT, UPDATE ON TABLE sgal97_s1_seq TO op;
GRANT SELECT ON TABLE sgal97_s1_seq TO prep;

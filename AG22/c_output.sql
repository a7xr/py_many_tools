...
mobile_d2 character varying(254),
  ...
  idenr integer NOT NULL DEFAULT nextval(('public.sgal75_c_seq'::text)::regclass),
  ...
  CONSTRAINT pk_sgal75__c PRIMARY KEY (idenr ),
  CONSTRAINT p_unique_sgal75__c UNIQUE (n_ima , n_lot , commande , n_enr )
)
WITH (
  OIDS=TRUE
);
ALTER TABLE sgal75_c
  OWNER TO pgtantely;
GRANT ALL ON TABLE sgal75_c TO pgtantely;
GRANT ALL ON TABLE sgal75_c TO op;
GRANT SELECT ON TABLE sgal75_c TO prep;

-- Index: idx1_sgal75__c

-- DROP INDEX idx1_sgal75__c;

CREATE INDEX idx1_sgal75__c
  ON sgal75_c
  USING btree
  (commande COLLATE pg_catalog."default" , n_lot COLLATE pg_catalog."default" , __s COLLATE pg_catalog."default" );

-- Index: idx2_sgal75__c

-- DROP INDEX idx2_sgal75__c;

CREATE INDEX idx2_sgal75__c
  ON sgal75_c
  USING btree
  (idexecute );

-- Index: idx3_sgal75__c

-- DROP INDEX idx3_sgal75__c;

CREATE INDEX idx3_sgal75__c
  ON sgal75_c
  USING btree
  (idenr );

-- Index: idx4_sgal75__c

-- DROP INDEX idx4_sgal75__c;

CREATE INDEX idx4_sgal75__c
  ON sgal75_c
  USING btree
  (n_lot COLLATE pg_catalog."default" );

-- Sequence: sgal75_c_seq

-- DROP SEQUENCE sgal75_c_seq;

CREATE SEQUENCE sgal75_c_seq
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE sgal75_c_seq
  OWNER TO pgtantely;
GRANT ALL ON TABLE sgal75_c_seq TO pgtantely;
GRANT SELECT, UPDATE ON TABLE sgal75_c_seq TO op;
GRANT SELECT ON TABLE sgal75_c_seq TO prep;

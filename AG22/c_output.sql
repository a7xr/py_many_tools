...
DROP TABLE IF EXISTS sgal85_c;

CREATE TABLE sgal85_c
(
...
presence_contrat_de_souscription character varying(254), 
presence_forfait character varying(254), 
...
codage_forfait character varying(254), 
codage_facture character varying(254), 
mobile_d2 character varying(254),
  ...
  idenr integer NOT NULL DEFAULT nextval(('public.sgal85_c_seq'::text)::regclass),
  ...
  CONSTRAINT pk_sgal85__c PRIMARY KEY (idenr ),
  CONSTRAINT p_unique_sgal85__c UNIQUE (n_ima , n_lot , commande , n_enr )
)
WITH (
  OIDS=TRUE
);
ALTER TABLE sgal85_c
  OWNER TO pgtantely;
GRANT ALL ON TABLE sgal85_c TO pgtantely;
GRANT ALL ON TABLE sgal85_c TO op;
GRANT SELECT ON TABLE sgal85_c TO prep;

-- Index: idx1_sgal85__c

DROP INDEX IF EXISTS idx1_sgal85__c;

CREATE INDEX idx1_sgal85__c
  ON sgal85_c
  USING btree
  (commande COLLATE pg_catalog."default" , n_lot COLLATE pg_catalog."default" , __s COLLATE pg_catalog."default" );

-- Index: idx2_sgal85__c

DROP INDEX IF EXISTS idx2_sgal85__c;

CREATE INDEX idx2_sgal85__c
  ON sgal85_c
  USING btree
  (idexecute );

-- Index: idx3_sgal85__c

DROP INDEX IF EXISTS idx3_sgal85__c;

CREATE INDEX idx3_sgal85__c
  ON sgal85_c
  USING btree
  (idenr );

-- Index: idx4_sgal85__c

DROP INDEX IF EXISTS idx4_sgal85__c;

CREATE INDEX idx4_sgal85__c
  ON sgal85_c
  USING btree
  (n_lot COLLATE pg_catalog."default" );

-- Sequence: sgal85_c_seq

DROP SEQUENCE IF EXISTS sgal85_c_seq;

CREATE SEQUENCE sgal85_c_seq
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE sgal85_c_seq
  OWNER TO pgtantely;
GRANT ALL ON TABLE sgal85_c_seq TO pgtantely;
GRANT SELECT, UPDATE ON TABLE sgal85_c_seq TO op;
GRANT SELECT ON TABLE sgal85_c_seq TO prep;
